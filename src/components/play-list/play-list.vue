<template>
  <transition name="list-fade">
    <div class="playlist" @click="hide" v-show="showFlag">
      ...
      <con-firm ref="confirm" @confirm="confirm" text="是否清空播放列表" confirmBtnText="清空"></con-firm>
  ...
  export default {
    ...
    methods: {
      ...
      scrollToCurrent(current) {
        const index = this.sequenceList.findIndex((songs) => {
          return current.id === songs.id
        })
      ...
      show() {
        ...
        setTimeout(() => {
          ...
          self.scrollToCurrent(this.currentSong)
        }, 20)
      },
      hide() {
        this.showFlag = false
